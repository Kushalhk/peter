...
# ⚠️ Please don't change our credits 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/TG_SUPPORTER>𝗧𝗚_Ø𝗪𝗡𝗘𝗥</a>
✯ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/TG_UPDATES1>𝙐𝙋𝘿𝘼𝙏𝙀𝙎_𝘾𝙃𝘼𝙉𝙉𝙀𝙇</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙺𝙾𝚈𝙴𝙱
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @TG_UPDATES1"""
    JSON_TXT = """<b>JSON:</b>
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ' : ( ! , . / )"""
    ...
    <code>[JOIN GROUP](buttonurl:https://t.me/movies_hub_official1)</code>"""
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/TG_LINKS_CHANNEL><b>𝙏𝙂 𝘾𝙃𝘼𝙉𝙉𝙀𝙇</b></a>"""
